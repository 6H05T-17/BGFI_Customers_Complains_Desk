<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Détail de la Réclamation : ' . $reclamation->numero) }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="col-span-2 border-b pb-4">
                        ...
                        @else
                            <p class="text-gray-500 italic text-sm">Aucun agent n'est encore assigné à cette
                                réclamation.</p>
                        @endif
                    </div>
                    ...
                    <div class="col-span-2 mt-8 border-t pt-6">
                        ...
                        <form action="{{ route('reclamations.commentaires.store', $reclamation) }}" method="POST"
                            ...
                            <div class="mb-4">
                                <label for="contenu"
                                    class="block text-sm font-medium text-gray-700 mb-1">Contenu</label>
